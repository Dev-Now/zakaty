...
class CalculationSheetAsDataTable extends StatefulWidget {
  final String title;
  const CalculationSheetAsDataTable({super.key, required this.title});

  @override
  State<CalculationSheetAsDataTable> createState() => _CalculationSheetAsDataTableState();
}

class _CalculationSheetAsDataTableState extends State<CalculationSheetAsDataTable> {
